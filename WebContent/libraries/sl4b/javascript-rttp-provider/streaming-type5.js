...
var z=function(){};
if(SL_ER("suppressexceptions")!==null){z = function(){if(!g_bStopped){g_eParent.z();}if(window._cleanUpScriptElements!==undefined){SL_NA();}};
}else 
{z = function(){if(!g_bStopped){
try {g_eParent.z();}catch(e){}
if(window._cleanUpScriptElements!==undefined){SL_NA();}}};
}function SL_NA(){if(g_nMessageCount>=const_SCRIPT_CLEANUP_LIMIT){g_nMessageCount=0;var l_nLength=g_nProcessedNumberOfScriptTags-1;
